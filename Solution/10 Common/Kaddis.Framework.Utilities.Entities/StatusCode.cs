...
namespace Kaddis.Framework.Utilities.Entities
{
    ...
    public enum StatusCode
    {
        ...
        /// <summary>
        /// Equivalent to HTTP status 203. System.Net.HttpStatusCode.NonAuthoritativeInformation indicates that the returned meta information is from a cached copy instead of the origin server and therefore may be incorrect.
        /// </summary>
        ...
        /// <summary>
        /// Equivalent to HTTP status 301. System.Net.HttpStatusCode.Error indicates that the requested information has an error.
        /// </summary>
        Error = 301,

        /// <summary>
        /// Equivalent to HTTP status 302. System.Net.HttpStatusCode.Found indicates that the requested information is
        /// located at the URI specified in the Location header. The default action when this status is received is to 
        /// follow the Location header associated with the response. When the original request method was POST, 
        ...
        /// <summary>
        /// Equivalent to HTTP status 307. System.Net.HttpStatusCode.RedirectKeepVerb indicates that the request information is located at the URI specified in the Location header. The default action when this status is received is to
        /// follow the Location header associated with the response. When the original request method was POST, the redirected request will also use the POST method.
        /// </summary>
        RedirectKeepVerb = 307,

        /// <summary>
        /// Equivalent to HTTP status 307. System.Net.HttpStatusCode.TemporaryRedirect indicates that the request information is located at the URI specified in
        /// the Location header. The default action when this status is received is to follow the Location header associated with the response. When the original request method was POST, the redirected request will also use the POST method.
        /// </summary>
        ...
        /// <summary>
        /// Equivalent to HTTP status 416. System.Net.HttpStatusCode.RequestedRangeNotSatisfying indicates that the range of data requested from the resource cannot be returned, either because the beginning of the range is before the beginning of the resource, or the end of the range is after the end of the resource.
        /// </summary>     
        ...
        /// <summary>
        /// The custom error. used with  custom error messages
        /// </summary>
        CustomError = 50000,
        ...
        /// </summary>
        UserRoleChanged = 50001,

        /// <summary>
        /// The uniform changed.
        /// </summary>
        UniformChanged = 50002,

        /// <summary>
        /// The item group changed.
        /// </summary>
        ItemGroupChanged = 50003,

        /// <summary>
        /// Item already added.
        /// </summary>
        ItemAlreadyAdded = 50004,

        /// <summary>
        /// Item already exists.
        /// </summary>
        ItemAlreadyExists = 50005,

        /// <summary>
        /// Used in roles and employees.
        /// </summary>
        UsedInRolesAndEmployees = 50006,
        ...
        /// Used in employees.
        /// </summary>
        UsedInEmployees = 50008,

        /// <summary>
        /// Used in uniforms.
        /// </summary>
        UsedInUniforms = 50009,

        /// <summary>
        /// Used in item groups.
        /// </summary>
        UsedInItemGroups = 50010,

        /// <summary>
        /// Username already exists.
        /// </summary>
        UsernameAlreadyExists = 50011,

        /// <summary>
        /// Email already exists.
        /// </summary>
        EmailAlreadyExists = 50012,

        /// <summary>
        /// Uniform already exists.
        /// </summary>
        UniformAlreadyExists = 50013,

        /// <summary>
        /// Role already exists.
        /// </summary>
        RoleAlreadyExists = 50014,

        /// <summary>
        /// Item group already exists.
        /// </summary>
        ItemGroupAlreadyExists = 50015,

        /// <summary>
        /// Unique Constraints Violation
        /// </summary>
        UniqueConstraintsError = 2627,
    }
}
